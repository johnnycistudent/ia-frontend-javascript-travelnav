...
### Features Left to Implement
  ...
  * Disable "Go to Website" link in infoWindow when the establishment doesn't have a website.
...
### Testing User Stories
  ...
  * As a user, I want to be able to search anywhere in the world on a map generated by this website.  
    ...
    **iv.** Verify that when one of the map buttons is clicked but there is no location entered in the search bar, the instructional modal pops up telling the user to enter a location in the search bar.
  ...
  * As a user, once I have entered my desired destination, I want to be able to search for tourist attractions/places of interest, places to eat or hotels near my searched location.  
    ...
    **iii.** Click on the "Restaurants" button to generate markers for places to eat and click on the "Hotels" button to generate markers for types of lodging establishments.   
...
### Bugs
  ...
  * When using the search bar above the map, if the user pressed enter instead of clicking one of the autosuggested results, the page would refresh as though a form was submitted due to the bootstrap form action. I fixed this with a jquery 
